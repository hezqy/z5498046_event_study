...
def backup(show_folder: bool = False, quiet: bool = False) -> None:
    """Backup files under the toolkityiping project folder

    This function will copy all (non-system) files under "toolkityiping" to a
    "dated" folder inside "toolkityiping/_backup". A new dated folder will be
    ...
    Example
    -------
    Suppose you only have the following files under toolkityiping:
    ...
    After the backup, your toolkityiping folder will look like this:
    ...
    msg = _Msg()
    msg.add("Backing up toolkityiping folder...", sep=True, bold=True)
...
def sync_dbox(quiet: bool = False) -> None:
    ...
    place the files under 'toolkityiping/_dropbox'. All existing files inside
    _dropbox will be replaced:

     <DROPBOX>/
     |__ toolkityiping/            <- Dropbox shared folder (SOURCE)
     |   |__ data/           
     |   |__ lectures/       
     |   |    ...
     ...
     |   |__ data/               <- Same as <DROPBOX>/toolkityiping/data above
     |   |__ lectures/           <- Same as <DROPBOX>/toolkityiping/lectures above
     |   |   ...                 <- Same as <DROPBOX>/toolkityiping/... above
     | ...
