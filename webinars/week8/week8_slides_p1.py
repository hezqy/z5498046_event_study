...
startday = dt.datetime(2000, 12, 31, hour=8)
dt_now = dt.datetime.now()
alive = dt_now - startday
aliveseconds = (alive.days * 24 * 60 * 60) + alive.seconds
#aliveseconds = alive.total_seconds()
print(aliveseconds)
# 2. How old will you be in 1,340 days
future = dt.datetime.now() + dt.timedelta(days=1340)
alive = future - startday
age = alive.days/365
print(age)
